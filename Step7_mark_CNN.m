...
load mylayers
% 学習用データの定義
imdshandTrain = imageDatastore('image_mark\train', 'IncludeSubfolders',true,'LabelSource','foldernames');
% テスト用データの定義
imdshandValidation = imageDatastore('image_mark\test', 'IncludeSubfolders',true,'LabelSource','foldernames');
%% 学習オプションの設定
...
save('netresult_mark.mat','net*','accuracy','m')
