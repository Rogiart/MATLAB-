...
load mylayers
% 学習用データの定義
imdshandTrain = imageDatastore('image_other\train', 'IncludeSubfolders',true,'LabelSource','foldernames');
% テスト用データの定義
imdshandValidation = imageDatastore('image_other\test', 'IncludeSubfolders',true,'LabelSource','foldernames');
%% 学習オプションの設定
...
save('netresult_other.mat','net*','accuracy','m')
